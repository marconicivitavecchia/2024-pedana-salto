...
|----------|---------|---------|-----------------|------------|
| Vref | $2^{23} \cdot \frac{2V_{REF}}{2V_{REF}}$ | $\frac{2^{23}}{2} \cdot (2) = \frac{2^{23}}{2}$ | 4.194.304 | 0x400000 |
| 0 | $\frac{2^{23}}{2} \cdot \left(\frac{0}{V_{REF}}\right)$ | $\frac{2^{23}}{2} \cdot (1-1) = 0$ | 0 | 0x000000 |
