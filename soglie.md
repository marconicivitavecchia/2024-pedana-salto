...
4. **Calibrazione delle soglie**:
   * Le soglie $\text{soglia}_\text{positivo}$ e $\text{soglia}_\text{negativo}$ vengono definite come $n\sigma$ (ad esempio, $n=3$) della deviazione standard del segnale a riposo.
