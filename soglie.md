...
4. **Calibrazione delle soglie**:
   ...
   * $\mathrm{soglia}_{\mathrm{positivo}}$ e $\mathrm{soglia}_{\mathrm{negativo}}$ vengono definite come $n\sigma$ (ad esempio, $n=3$) della deviazione standard del segnale a riposo.
