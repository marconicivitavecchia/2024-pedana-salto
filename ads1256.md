...
```markdown
| ADS1256 Pin | ESP32 Heltec V3 Pin | Funzione |
|-------------|---------------------|-----------|
| SCLK        | GPIO47 (SPICLK_P)  | Clock SPI |
| DIN         | GPIO35 (GPIO35)    | Data Input (MOSI) |
| DOUT        | GPIO36 (GPIO36)    | Data Output (MISO) |
| CS          | GPIO37 (GPIO37)    | Chip Select |
| DRDY        | GPIO38 (GPIO38)    | Data Ready |
| PWDN        | 3.3V (VDD_3V3)    | Power Down |
| DGND        | GND               | Ground Digitale |
| AGND        | GND               | Ground Analogico |
| AVDD        | 3.3V (VDD_3V3)    | Alimentazione Analogica |
| DVDD        | 3.3V (VDD_3V3)    | Alimentazione Digitale |
| DAC1        | GPIO1             | DAC output 1 |
| DAC2        | GPIO2             | DAC output 2 |
```
